						...
						<div class="wrap-table-shopping-cart">
							...
							<table class="table-shopping-cart">
                                ...
                                @php
                                    ...
                                    $subTotal = $price * $carts[$product->id];
                                    $total += $subTotal;
                                @endphp
								<tr class="table_row">
									<td class="column-1">
									...
									<td class="column-5">{{number_format($subTotal, 0, ',','.') . ' VND'  }}</td>
                                    <td class="p-r-15">
                                        <a href="cart/delete/{{ $product->id }}" class="btn btn-warning btn-lg"><i class="fa fa-trash"></i></a>
                                    </td>
								</tr>
                                @endforeach
